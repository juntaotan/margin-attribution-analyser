...
import dev.margintrace.margin_attribution_backend.warehouse.model.AccountPayableLineId;
import org.springframework.data.jpa.repository.JpaRepository;

import java.util.List;
import java.util.Optional;

public interface AccountPayableLineRepository extends JpaRepository<AccountPayableLine, AccountPayableLineId> {
