...
class DatabaseWriterHandlerTests {
    ...
    void createsTableAndInsertsExcelRows() throws Exception {
        ...
        assertThat(jdbcTemplate.queryForObject("SELECT COUNT(*) FROM sales_data", Integer.class))
                .isEqualTo(2);
        assertThat(jdbcTemplate.queryForMap("SELECT order_no_0, total_price_0 FROM sales_data WHERE id = 1"))
